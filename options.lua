    ...
    CVarSettings = {
      ...
      args = {
        ...
        nameplateInset = {
          ...
          width = "full",
          get = function(info)
            return db.nameplateInset
              or ((GetCVar("nameplateOtherTopInset") == "-1") and (GetCVar("nameplateOtherBottomInset") == "-1"))
          end,
          set = function(info, value)
            if value then
                ...
                if newSpellInfo then
                  ...
                  elseif spellID ~= Spell.spellID and newSpellInfo.name ~= Spell.name then
                    ...
                    DEFAULT_CHAT_FRAME:AddMessage(
                      spellID
                        .. chatColor
                        .. L[" It is ID of completely different spell "]
                        .. linkColor
                        .. "|Hspell:"
                        .. spellID
                        .. "|h["
