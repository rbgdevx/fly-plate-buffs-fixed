...
local regionKey = regionTable[GetActualRegion()]
if not regionKey then
	print("AceDB-3.0: Unknown Region, please report to the addon author", "Region ID: " .. GetActualRegion())
end
local usedRegionKey = regionKey or "UNKNOWN_REGION"
local factionrealmregionKey = factionrealmKey .. " - " .. usedRegionKey
...
function DBObjectLib:RegisterNamespace(name, defaults)
	...
	if self.children and self.children[name] then
		error(
			"Usage: AceDBObject:RegisterNamespace(name, defaults): 'name' - a namespace with that name already exists.",
			2
		)
	end
